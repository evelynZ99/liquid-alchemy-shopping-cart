...
function App() {
  ...
  const flavourMeta = {
    "Cucumber Salad Single": {
      level: 40,
      sweet: 20,
      sour: 65,
      note: "Savory & bright",
    },
    "Pineappu Beach Single": {
      level: 55,
      sweet: 75,
      sour: 60,
      note: "Sweet & sour",
    ...
    "Smoky Chile & Honey": {
      ...
      sweet: 60,
      sour: 52,
      note: "Smoky, spicy, honeyed",
    },
    "Carrot Cake": {
      level: 58,
      sweet: 72,
      sour: 48,
      note: "Creamy, spiced, dessert-like",
    },
    "Tomato Cobbler": {
      level: 38,
      sweet: 50,
      sour: 68,
      note: "Savory, fresh, bright",
    },
    "Kicu In The Sidecar": {
      level: 55,
      sweet: 56,
      sour: 58,
      note: "Floral, citrus, rounded",
    },
    "Shiozakura Collins": {
      level: 50,
      sweet: 46,
      sour: 64,
      note: "Refreshing, saline, sparkling",
    },
  };
