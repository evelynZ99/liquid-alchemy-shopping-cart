...
|---|---|---|
| **Evelyn Zhou** | Project initialisation (MVP setup, DB schema, seed data, README & design docs); global design system (typography, colour tokens, component styles); Home (landing page), ProductListing (live search, filters), ProductDetail, Laboratory pages; Navbar & Footer; Age Verification Modal; guest cart & wishlist (localStorage + login merge); admin panel improvements (carts accordion); mobile responsive design across all pages | `pages/Home.jsx`, `pages/ProductListing.jsx`, `pages/ProductDetail.jsx`, `pages/Laboratory.jsx`, `components/Navbar.jsx`, `components/Footer.jsx`, `components/AgeVerificationModal.jsx`, `utils/guestCart.js`, `services/api.js`, `App.css`, `database/seed_data.sql`, `pages/admin/AdminCarts.jsx` |
